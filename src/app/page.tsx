    ...
    <div>
      ...
      <section className="px-5 py-20 md:px-10 md:py-28">
        ...
        <ol className="mt-14 divide-y divide-brass/15 border-y border-brass/15">
          {partner.map((phase, i) => (
            ...
            >
              <span className="font-mono text-xs text-brass md:col-span-1">
                0{i + 1}
              </span>
              <span className="font-display text-3xl md:col-span-3">{phase.name}</span>
              <span className="text-sm leading-7 text-smoke md:col-span-8 md:text-base md:leading-8">
                {phase.copy}
              </span>
            </li>
          ))}
      ...
      <section className="border-t border-brass/15 px-5 py-24 md:px-10 md:py-32">
        ...
        <div className="mt-12 flex flex-wrap gap-8">
          ...
          <Link
            href="/lookbook"
            className="inline-flex items-center text-[11px] uppercase tracking-[0.22em] text-brass hover:text-paper"
          >
            Open the lookbook →
          </Link>
        </div>
